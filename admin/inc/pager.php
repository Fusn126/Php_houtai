...
function pager_query($sql,&$nav_html,$page_current=1, $page_size=9){
	//全局变量与局部变量的区别
	global $db;
	...
	$nav_html = <<< EOT
  <div id="pager"> 
	<button type="button" class="btn btn-default"> <a href="$page_first_q">首页</a></button>
	<button type="button" class="btn btn-default"><a href="$page_previous_q">上一页</a></button>
	<button type="button" class="btn btn-default"><a href="$page_next_q">下一页</a> </button>   
	<button type="button" class="btn btn-default"><a href="$page_last_q">末页</a> </button> 
	<button type="button" class="btn btn-primary"> <span>当前第$page_current 页</span></button>
	<button type="button" class="btn btn-primary"> <span>总共 $page_amount 页</span> </button>
  </div>    
EOT;
